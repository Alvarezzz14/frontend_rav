<template>
  ...
  <p class="text-black mb-0 text-2xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur doloribus culpa, asperiores animi quisquam numquam quis? Est voluptatum eaque quidem maiores cum voluptatibus esse quae, vitae ab iure pariatur facere!</p>
  <p></p>
  ...
  <transition name="fade">
    <div v-if="fileName" class="file-info">
      ...
      <button @click="uploadFile" class="upload-button">Enviar Archivo</button>
    </div>
  </transition>
...
export default {
  ...
  methods: {
    ...
    uploadFile() {
      ...
      fetch('http://your-upload-endpoint.com', {
        method: 'POST',
        body: formData,
      })
      .then(response => {
