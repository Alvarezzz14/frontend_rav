<template>
	...
	<div class="min-h-screen bg-customPurple text-white flex flex-col">
		...
		<!-- Contenedor del grid -->
		<div
			class="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-x-6 p-8 lg:p-16 z-50">
			...
			<div class="flex flex-col justify-center space-y-6">
				...
				<form
					...
					<button
						...
						:disabled="isLoading"
						class="border-none border-moradoSecundario mt-4 w-full py-3 text-lg text-black font-bold rounded-lg transition-colors">
						<span v-if="!isLoading">Iniciar sesión</span>
						<span v-else>Cargando...</span>
					</button>
				</form>
				<!-- Iconos institucionales -->
				<div class="flex justify-center space-x-4 mt-8 z-30">
					<img
			...
			<div class="lg:flex justify-center">
				<img :src="MapaCollage" alt="Mapa" class="h-full w-full z-30" />
			</div>
		</div>
