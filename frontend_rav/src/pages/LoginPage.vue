<template>
	...
	>
		...
		<div class="md:w-1/2 w-full flex flex-col justify-center items-center p-6 bg-black/70 md:bg-transparent">
			<!-- Logo -->
			<img :src="Logo" alt="Logo RAV" class="w-40 md:w-64 h-auto mb-6" />

			<!-- Título de inicio de sesión -->
			<h2 class="text-xl md:text-3xl font-semibold text-white text-center">Iniciar Sesión</h2>
