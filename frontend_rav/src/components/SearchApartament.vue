    ...
    <div class="flex flex-col items-center space-y-4">
        ...
        <div v-if="selectedInfo" class="w-full max-w-md p-4 rounded-lg shadow-lg bg-white">
            ...
            <div class="bg-customPurple text-white py-2 px-4 flex items-center">
                ...
                <img v-if="selectedInfo" :src="`/Fragmento_Departamentos/${selectedInfo.name}.svg`"
                    :alt="`Mapa de ${selectedInfo.name}`" class="ml-auto w-8 h-8" />
            </div>
...
const departamentos = ref([
    { name: "Amazonas", code: "91", flagUrl: "/images/webp/amazonas.webp", imageUrl: "/images/imagenDepartamento/Amazonas.svg" },
    { name: "Antioquia", code: "05", flagUrl: "/images/webp/antioquia.webp", imageUrl: "/images/imagenDepartamento/antioquia.svg" },
    { name: "Arauca", code: "81", flagUrl: "/images/webp/arauca-departamento.webp", imageUrl: "/images/imagenDepartamento/arauca-departamento.svg" },
    { name: "Atlantico", code: "08", flagUrl: "/images/webp/atlantico.webp", imageUrl: "/images/imagenDepartamento/atlantico.svg" },
    { name: "Bolivar", code: "13", flagUrl: "/images/webp/bolivar.webp", imageUrl: "/images/imagenDepartamento/bolivar.svg" },
    { name: "Boyaca", code: "15", flagUrl: "/images/webp/boyaca.webp", imageUrl: "/images/imagenDepartamento/boyaca.svg" },
    { name: "Caldas", code: "17", flagUrl: "/images/webp/caldas.webp", imageUrl: "/images/imagenDepartamento/caldas.svg" },
    { name: "Caqueta", code: "18", flagUrl: "/images/webp/caqueta.webp", imageUrl: "/images/imagenDepartamento/caqueta.svg" },
    { name: "Casanare", code: "85", flagUrl: "/images/webp/casanare.webp", imageUrl: "/images/imagenDepartamento/casanare.svg" },
    { name: "Cauca", code: "19", flagUrl: "/images/webp/cauca.webp", imageUrl: "/images/imagenDepartamento/cauca.svg" },
    { name: "Cesar", code: "20", flagUrl: "/images/webp/cesar.webp", imageUrl: "/images/imagenDepartamento/cesar.svg" },
    { name: "Choco", code: "27", flagUrl: "/images/webp/choco.webp", imageUrl: "/images/imagenDepartamento/choco.svg" },
    { name: "Cundinamarca", code: "25", flagUrl: "/images/webp/cundinamarca.webp", imageUrl: "/images/imagenDepartamento/cundinamarca.svg" },
    { name: "Cordoba", code: "23", flagUrl: "/images/webp/cordoba.webp", imageUrl: "/images/imagenDepartamento/cordoba.svg" },
    { name: "Guainia", code: "94", flagUrl: "/images/webp/guainia.webp", imageUrl: "/images/imagenDepartamento/guainia.svg" },
    { name: "Guaviare", code: "95", flagUrl: "/images/webp/guaviare.webp", imageUrl: "/images/imagenDepartamento/guaviare.svg" },
    { name: "Huila", code: "41", flagUrl: "/images/webp/huila.webp", imageUrl: "/images/imagenDepartamento/huila.svg" },
    { name: "La Guajira", code: "44", flagUrl: "/images/webp/guajira.webp", imageUrl: "/images/imagenDepartamento/guajira.svg" },
    { name: "Magdalena", code: "47", flagUrl: "/images/webp/magdalena.webp", imageUrl: "/images/imagenDepartamento/magdalena.svg" },
    { name: "Meta", code: "50", flagUrl: "/images/webp/meta.webp", imageUrl: "/images/imagenDepartamento/meta.svg" },
    { name: "Nariño", code: "52", flagUrl: "/images/webp/nariño.webp", imageUrl: "/images/imagenDepartamento/nariño.svg" },
    { name: "Norte de Santander", code: "54", flagUrl: "/images/webp/norte-de-santander.webp", imageUrl: "/images/imagenDepartamento/norte-de-santander.svg" },
    { name: "Putumayo", code: "86", flagUrl: "/images/webp/putumayo.webp", imageUrl: "/images/imagenDepartamento/putumayo.svg" },
    { name: "Quindio", code: "63", flagUrl: "/images/webp/quindio.webp", imageUrl: "/images/imagenDepartamento/quindio.svg" },
    { name: "Risaralda", code: "66", flagUrl: "/images/webp/risaralda.webp", imageUrl: "/images/imagenDepartamento/risaralda.svg" },
    { name: "San Andres, Providencia y Santa Catalina", code: "88", flagUrl: "/images/webp/san-andres-y-providencia.webp", imageUrl: "/images/imagenDepartamento/san-andres-y-providencia.svg" },
    { name: "Santander", code: "68", flagUrl: "/images/webp/santander.webp", imageUrl: "/images/imagenDepartamento/santander.svg" },
    { name: "Sucre", code: "70", flagUrl: "/images/webp/sucre.webp", imageUrl: "/images/imagenDepartamento/sucre.svg" },
    { name: "Tolima", code: "73", flagUrl: "/images/webp/tolima.webp", imageUrl: "/images/imagenDepartamento/tolima.svg" },
    { name: "Valle del Cauca", code: "76", flagUrl: "/images/webp/valle-del-cauca.webp", imageUrl: "/images/imagenDepartamento/valle-del-cauca.svg" },
    { name: "Vaupes", code: "97", flagUrl: "/images/webp/vaupes.webp", imageUrl: "/images/imagenDepartamento/vaupes.svg" },
    { name: "Vichada", code: "99", flagUrl: "/images/webp/vichada.webp", imageUrl: "/images/imagenDepartamento/vichada.svg" },
]);
