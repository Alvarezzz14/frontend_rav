<template>
    <div class="flex flex-col items-center space-y-4">
      ...
      <div v-if="selectedInfo" class="w-full max-w-md p-4 rounded-lg shadow-lg bg-white">
        ...
        <div class="bg-customPurple text-white py-2 px-4 flex items-center">
          ...
          <!-- Icono o imagen pequeña, si aplica -->
          <i class="ml-auto pi pi-globe"></i>
        </div>
  ...
  const departamentos = ref([
    { name: "Amazonas", code: "91", flagUrl: "/images/webp/amazonas.webp", imageUrl: "/images/webp/amazonas.webp" },
    { name: "Antioquia", code: "05", flagUrl: "/images/webp/antioquia.webp", imageUrl: "/images/webp/antioquia.webp" },
    { name: "Arauca", code: "81", flagUrl: "/images/webp/arauca-departamento.webp", imageUrl: "/images/webp/arauca-departamento.webp" },
    { name: "Atlantico", code: "08", flagUrl: "/images/webp/atlantico.webp", imageUrl: "/images/webp/atlantico.webp" },
    { name: "Bolivar", code: "13", flagUrl: "/images/webp/bolivar.webp", imageUrl: "/images/webp/bolivar.webp" },
    { name: "Boyaca", code: "15", flagUrl: "/images/webp/boyaca.webp", imageUrl: "/images/webp/boyaca.webp" },
    { name: "Caldas", code: "17", flagUrl: "/images/webp/caldas.webp", imageUrl: "/images/webp/caldas.webp" },
    { name: "Caqueta", code: "18", flagUrl: "/images/webp/caqueta.webp", imageUrl: "/images/webp/caqueta.webp" },
    { name: "Casanare", code: "85", flagUrl: "/images/webp/casanare.webp", imageUrl: "/images/webp/casanare.webp" },
    { name: "Cauca", code: "19", flagUrl: "/images/webp/cauca.webp", imageUrl: "/images/webp/cauca.webp" },
    { name: "Cesar", code: "20", flagUrl: "/images/webp/cesar.webp", imageUrl: "/images/webp/cesar.webp" },
    { name: "Choco", code: "27", flagUrl: "/images/webp/choco.webp", imageUrl: "/images/webp/choco.webp" },
    { name: "Cundinamarca", code: "25", flagUrl: "/images/webp/cundinamarca.webp", imageUrl: "/images/webp/cundinamarca.webp" },
    { name: "Cordoba", code: "23", flagUrl: "/images/webp/cordoba.webp", imageUrl: "/images/webp/cordoba.webp" },
    { name: "Guainia", code: "94", flagUrl: "/images/webp/guainia.webp", imageUrl: "/images/webp/guainia.webp" },
    { name: "Guaviare", code: "95", flagUrl: "/images/webp/guaviare.webp", imageUrl: "/images/webp/guaviare.webp" },
    { name: "Huila", code: "41", flagUrl: "/images/webp/huila.webp", imageUrl: "/images/webp/huila.webp" },
    { name: "La Guajira", code: "44", flagUrl: "/images/webp/guajira.webp", imageUrl: "/images/webp/guajira.webp" },
    { name: "Magdalena", code: "47", flagUrl: "/images/webp/magdalena.webp", imageUrl: "/images/webp/magdalena.webp" },
    { name: "Meta", code: "50", flagUrl: "/images/webp/meta.webp", imageUrl: "/images/webp/meta.webp" },
    { name: "Nariño", code: "52", flagUrl: "/images/webp/nariño.webp", imageUrl: "/images/webp/nariño.webp" },
    { name: "Norte de Santander", code: "54", flagUrl: "/images/webp/norte-de-santander.webp", imageUrl: "/images/webp/norte-de-santander.webp" },
    { name: "Putumayo", code: "86", flagUrl: "/images/webp/putumayo.webp", imageUrl: "/images/webp/putumayo.webp" },
    { name: "Quindio", code: "63", flagUrl: "/images/webp/quindio.webp", imageUrl: "/images/webp/quindio.webp" },
    { name: "Risaralda", code: "66", flagUrl: "/images/webp/risaralda.webp", imageUrl: "/images/webp/risaralda.webp" },
    { name: "San Andres, Providencia y Santa Catalina", code: "88", flagUrl: "/images/webp/san-andres-y-providencia.webp", imageUrl: "/images/webp/san-andres-y-providencia.webp" },
    { name: "Santander", code: "68", flagUrl: "/images/webp/santander.webp", imageUrl: "/images/webp/santander.webp" },
    { name: "Sucre", code: "70", flagUrl: "/images/webp/sucre.webp", imageUrl: "/images/webp/sucre.webp" },
    { name: "Tolima", code: "73", flagUrl: "/images/webp/tolima.webp", imageUrl: "/images/webp/tolima.webp" },
    { name: "Valle del Cauca", code: "76", flagUrl: "/images/webp/valle-del-cauca.webp", imageUrl: "/images/webp/valle-del-cauca.webp" },
    { name: "Vaupes", code: "97", flagUrl: "/images/webp/vaupes.webp", imageUrl: "/images/webp/vaupes.webp" },
    { name: "Vichada", code: "99", flagUrl: "/images/webp/vichada.webp", imageUrl: "/images/webp/vichada.webp" },
  ]);
