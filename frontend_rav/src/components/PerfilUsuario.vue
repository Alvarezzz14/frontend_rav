<template>
    <div class="bg-gray-100 p-4 rounded-lg shadow-md">
      ...
      <!-- Sección del formulario de datos de usuario -->
      <div class="user-data-form">
        <div class="column">
            <label>TIPO DE DOCUMENTO:</label>
                <p>asjjasjasjasjasj</p>
...
.p{
  ...
  .text-customPurple {
    color: #741E78; /* Ajusta según tu color deseado */
  }
  </style>
