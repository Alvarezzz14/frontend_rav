<template>
  <div
    class="circular-chart-container rounded-[20px] flex flex-col items-center justify-center relative p-2 w-[360px] h-[249px] lg:w-[240px] lg:h-[240px]"
  >
    ...
    <div class="relative w-[118px] h-[118px] flex-shrink-0 mb-[20px]">
      ...
      >
        ...
        <circle cx="64" cy="14" r="7.375" fill="#FDC300" />
      ...
      <div class="absolute inset-0 flex items-center justify-center">
        <span
          class="font-['Work_Sans'] font-bold text-[24px] leading-[28px] text-center text-white"
        >
    ...
    <div class="flex flex-col w-full px-[19.69px] gap-[7px]">
      ...
      <div class="flex flex-row items-center gap-[7px]">
        <div
          class="w-[16px] h-[16px] bg-white rounded-[30px] flex items-center justify-center flex-shrink-0"
        >
          <svg
            width="7"
            height="8"
        ...
        <span
          class="font-['Work_Sans'] font-normal text-[12px] leading-[14px] text-white"
        >
          Meta Anual
        </span>
        <span
          class="font-['Work_Sans'] font-bold text-[14px] leading-[16px] text-white ml-auto"
        >
          {{ goal.limit || 0 }}
        </span>
      </div>
      ...
      <div class="flex flex-row items-center gap-[7px]">
        ...
        >
          ...
          >
            <path
              d="M3.657 2.046C3.478 2.226 3.478 2.521 3.657 2.701L4.597 3.641L2 3.641C1.723 3.641 1.5 3.864 1.5 4.141C1.5 4.418 1.723 4.641 2 4.641L4.597 4.641L3.657 5.581C3.478 5.761 3.478 6.056 3.657 6.236C3.837 6.416 4.132 6.416 4.312 6.236L6.315 4.233C6.495 4.053 6.495 3.758 6.315 3.578L4.312 1.575C4.132 1.395 3.837 1.395 3.657 1.575Z"
              fill="#005DCA"
            />
...
<style scoped>
/* Borde gradiente solo mobile. Usamos doble background para un borde 1px nítido con border-radius. */
.circular-chart-container {
  /* Capa 1: fondo interno; Capa 2: borde gradiente */
  background:
    linear-gradient(#002C4D, #002C4D) padding-box,
    linear-gradient(90deg, #005DCA 0%, #003B8A 88.46%, #003B8A 98.08%) border-box;
  border: 1px solid transparent;
}

@media (min-width: 1024px) {
  .circular-chart-container {
    /* Desktop: fondo sólido y sin borde */
    background: #002C4D;
    border: 0;
    width: 240px;
    height: 240px;
