<template>
  <div>
    ...
    <div
      class="mt-4 bg-white rounded-lg md:w-auto sm:w-auto lg:w-auto xl:w-auto xxl:w-auto shadow p-4 space-y-6"
    >
      <!-- Primer contenedor -->
      <div class="flex flex-wrap items-center gap-4">
        ...
        <div class="flex items-center gap-40">
          ...
          <div
            class="flex flex-wrap gap-4 md:w-auto sm:w-auto lg:w-auto xl:w-auto xxl:w-auto text-right"
          >
            <!-- Campo de select -->
            <select
      ...
      <div class="flex flex-wrap items-center gap-4 relative">
        ...
        <div class="flex items-center gap-2">
          <div
            class="p-2 md:w-auto sm:w-auto lg:w-auto xl:w-auto xxl:w-auto bg-customPurple rounded-full"
          >
            <img
        ...
        <table class="w-full border-collapse">
          ...
          <tbody>
            <tr v-for="module in modules" :key="module.id">
              ...
              <td class="border border-gray-300 p-2">
                <div class="flex items-center gap-2">
                  <input
                    ...
                    :class="{
                      'bg-emerald-500 border-emerald-500': isModuleSelected(
                        module.id
                      ),
              ...
              <td
                v-for="permiso in permisosTipos"
                :key="permiso.id"
              ...
              >
                <input
                  ...
                  :checked="
                    selectedPermissions[module.id]?.includes(permiso.id)
                  "
                />
              </td>
            </tr>
...
const selectCheckBoxAndModule = (event, permisoId, moduleId) => {
  ...
  if (event.target.checked) {
    ...
    selectedPermissions.value[moduleId] = selectedPermissions.value[
      moduleId
...
const toggleAllModulePermissions = (module, event) => {
  ...
  checkboxes.forEach((checkbox) => {
    if (
      checkbox.hasAttribute("data-module-id") &&
