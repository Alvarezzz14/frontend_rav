<template>
  <div
    ...
    :class="[
      isExpanded ? 'w-[266px] bg-azul-gradian sidebar-activity-container' : 'w-[50px]'
    ]"
  ...
  >
    ...
    <div 
      ...
      :class="[
        isExpanded 
          ? 'activity-btn-expanded mt-5 bg-amarillo' 
    ...
    >
      ...
      <span 
        v-if="isExpanded"
        class="font-['Work_Sans'] font-bold text-[21px] leading-[25px] text-azulApe whitespace-nowrap"
      >
        Actividad
      </span>
    </div>
    ...
    <div 
      v-if="isExpanded" 
      class="flex-1 overflow-y-auto overflow-x-hidden px-[13px] py-5 transition-all duration-700"
    >
      <div
