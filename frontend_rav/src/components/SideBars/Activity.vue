<template>
  ...
  >
    ...
    <div 
      class="flex flex-row items-center gap-3 bg-amarillo shadow-[0px_4px_4px_rgba(0,0,0,0.25)] flex-shrink-0 mx-auto transition-all duration-700"
      :class="[
    ...
    >
      ...
      <span 
        v-if="isExpanded"
        class="font-['Work_Sans'] font-bold text-[21px] leading-[25px] text-[#71277A] whitespace-nowrap"
      >
        Actividad
      </span>
    </div>
