<template>
    <div class="bg-gray-100 flex items-center justify-between p-4 rounded-lg shadow-md">
        ...
        <button class="bg-azulBarraApe text-white p-4 rounded-lg shadow flex flex-col items-center">
    ...
    <div class="mt-4 bg-white rounded-lg shadow p-4">
        <ul class="list-decimal pl-5 ">
            <li class="flex items-center pb-2">
                <span
                    class="bg-azulBarraApe  text-white font-bold rounded-full w-6 h-6 flex items-center justify-center mr-2">1</span>
