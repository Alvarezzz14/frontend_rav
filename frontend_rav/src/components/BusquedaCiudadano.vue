		...
		<div class="relative w-[30px] h-[29.93px] flex-none">
			...
			<div class="absolute inset-0 flex items-center justify-center">
				<IconSearch 
					:size="16.5" 
					color="white" 
					class="w-[16.5px] h-[16.5px]" />
			</div>
		</div>
		
		<!-- Texto "Búsqueda del ciudadano" -->
		<h1 class="w-[607px] h-[41px] font-work-sans font-bold text-[30px] leading-[35px] text-[#71277A] flex-none">
	...
	<div class="relative">
		...
		<div class="flex flex-col lg:flex-row-reverse items-center mt-8">
			<div class="-mt-44 lg:w-full lg:mx-14">
				<!-- Titulo-->
				<p class="text-center lg:text-left font-medium text-[32px] leading-[38px]">
					Aquí podrás visualizar información acerca de la
				</p>

				<h2 class="text-center lg:text-left -mt-5 font-bold text-customPurple text-[80px] leading-[75px]">
				...
				<div class="absolute left-[723px] top-[460px] w-[785px] h-[197px] bg-white shadow-[0px_4px_4px_rgba(0,0,0,0.1)] rounded-[20px] flex flex-col items-center justify-center gap-4 p-6">
					...
					<div class="flex flex-col items-end gap-4 w-[750px]">
						...
						<Button 
							...
							<svg v-if="!loading" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="flex-none">
								<path d="M8 2C4.686 2 2 4.686 2 8C2 11.314 4.686 14 8 14C9.336 14 10.576 13.566 11.584 12.832L16.376 17.624C16.566 17.814 16.784 17.91 17.032 17.91C17.532 17.91 17.91 17.532 17.91 17.032C17.11 16.784 17.814 16.566 17.624 16.376L12.832 11.584C13.566 10.576 14 9.336 14 8C14 4.686 11.314 2 8 2ZM8 3.5C10.486 3.5 12.5 5.514 12.5 8C12.5 10.486 10.486 12.5 8 12.5C5.514 12.5 3.5 10.486 3.5 8C3.5 5.514 5.514 3.5 8 3.5Z" fill="white"/>
							</svg>
...
.document-select option:checked {
