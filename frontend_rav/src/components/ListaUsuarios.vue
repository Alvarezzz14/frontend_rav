<template>
	<div class="min-h-screen p-4 flex flex-col items-center justify-stretch">
		<!-- Sección Superior -->
		<div
			class="flex flex-col md:flex-row items-center justify-between p-2 rounded-lg w-full max-w-7xl mb-8">
			...
			<table class="min-w-full table-auto">
				...
				<tbody>
					<tr
						...
						<td
							class="p-4 border-b border-gray-300 flex justify-center items-center">
							<!-- Botón Ver -->
							<button
								@click="viewUser(user)"
