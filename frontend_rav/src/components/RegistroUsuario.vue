<template>
	<div class="h-screen flex items-center justify-center bg-gray-100">
		...
		<div
			...
			<div
				class="flex-1 flex items-center justify-center h-full relative z-10 p-4 lg:p-0">
				<div
					...
					<!-- Título -->
					<h2 class="text-3xl font-semibold text-black m-2 text-center">
						Registrar Usuario
					</h2>
					...
					<form @submit.prevent="submitForm" class="space-y-3 w-full">
						...
						<button
							type="submit"
							class="w-full bg-customPurple text-amarillo font-bold py-2 text-lg rounded-lg cursor-pointer transition duration-200">
							Registrarse
						</button>
					</form>
					...
					<p class="text-black mt-2 text-center text-sm">
						...
						<a
							...
							href="#"
							class="text-azulHeaderFooter no-underline font-normal"
							>Inicia Sesión</a
						>
					</p>
...
async function submitForm() {
	...
	try {
		...
		const payload = {
			...
			numero_documento: formData.documento, // Valor quemado
