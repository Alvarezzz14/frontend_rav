    ...
    <div
      ...
      <div class="flex items-center mb-4 lg:mb-0">
        <div class="p-3.5 bg-customPurple rounded-full">
          <img :src="VerLine" alt="VerLine" class="w-4 h-4 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-16 lg:h-16" />
        </div>
      ...
      <button
        ...
        <!-- Ícono -->
        <img :src="ruta" alt="Ruta de Atención" class="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 mb-2" />
        <!-- Texto -->
        <span class="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl">Ruta de Atención</span>
      </button>
    </div>
